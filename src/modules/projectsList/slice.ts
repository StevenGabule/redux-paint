...
export const projectsListSelector = (state: RootState) => state.projectsList.projects;
export const projectsListPendingSelector = (state: RootState) => state.projectsList.pending;
export const projectsListErrorSelector = (state: RootState) => state.projectsList.error;
